...
void
spMultiply(char * eMatrix,RealVector RHS,RealVector Solution IMAG_VECTORS )
{  
	ElementPtr  pElement;
  RealVector  Vector;
  RealNumber  Sum;
...
void
spMultTransposed(char * eMatrix,RealVector RHS, RealVector Solution IMAG_VECTORS )
{
  ElementPtr  pElement;
  RealVector  Vector;
  RealNumber  Sum;
...
{
MatrixPtr  Matrix = (MatrixPtr)eMatrix;
FillinListNodeStruct  *pListNode;
