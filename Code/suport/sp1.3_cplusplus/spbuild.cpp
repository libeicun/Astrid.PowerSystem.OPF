...
int
spGetAdmittance(char  * Matrix,int   Node1,int   Node2,spTemplate  * Template )
{
...
int
spGetQuad( char  *Matrix,int   Row1, int  Row2, int  Col1, int  Col2, spTemplate  *Template )
{
/* Begin `spGetQuad'. */
...
int
spGetOnes(char  *Matrix, int  Pos,int   Neg,int   Eqn,spTemplate  * Template)
{
/* Begin `spGetOnes'. */
...
/* Begin `spGetInitInfo'. */
    ...
    return (char *)((ElementPtr)pElement)->pInitInfo;
				...
				typedef	int(*spFpRInt4Para)(RealNumber *,char*,int,int);
int
spInitialize(char* eMatrix, spFpRInt4Para pInit)
{
MatrixPtr Matrix = (MatrixPtr)eMatrix;
